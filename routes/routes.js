...
Router.route('/users/me/interests').post(checkToken, checkSkinTerest, addSkinTerest).delete(checkToken, checkSkinTerest, deleteSkinTerest)
Router.route('/users/me/skills').post(checkToken, checkSkinTerest, addSkinTerest).delete(checkToken, checkSkinTerest, deleteSkinTerest)
