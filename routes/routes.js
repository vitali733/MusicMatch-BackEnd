...
Router.route('/users/me/interests').post(checkToken, checkSkinTerest, addSkinTerest)
Router.route('/users/me/interests/delete').put(checkToken, checkSkinTerest, deleteSkinTerest)
Router.route('/users/me/skills').post(checkToken, checkSkinTerest, addSkinTerest)
Router.route('/users/me/skills/delete').put(checkToken, checkSkinTerest, deleteSkinTerest)
